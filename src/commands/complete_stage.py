...
import config
import crypto
from commands.get_friend import get_friend_command
from commands.refill_stamina import refill_stamina_command
...
def complete_stage_command(stage_id, difficulty, kagi=None):
    ...
    url = config.gb_url + '/quests/' + stage_id + '/sugoroku_maps/start'
