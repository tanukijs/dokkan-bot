...
def complete_clash_command():
  ...
  url = config.game_env.url + '/resources/home?rmbattles=true'
  ...
  url = config.game_env.url + '/rmbattles/' + str(clash_id) + '/stages/dropout'
  ...
  url = config.game_env.url + '/rmbattles/' + str(clash_id)
  ...
  url = config.game_env.url + '/rmbattles/available_user_cards'
  ...
  url = config.game_env.url + '/rmbattles/teams/1'
  ...
  for stage in available_stages:
    ...
    url = config.game_env.url + '/rmbattles/' + str(clash_id) + '/stages/' + str(stage) + '/start'
    ...
    url = config.game_env.url + '/rmbattles/' + str(clash_id) + '/stages/finish'
